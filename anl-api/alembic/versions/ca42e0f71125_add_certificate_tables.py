...
Revision ID: ca42e0f71125
Revises: 
Create Date: 2021-08-21 04:04:13.083319
...
def upgrade():
    ...
    sa.Column('consignor_be_sub_region_guid', sa.String(length=36), nullable=True),
    sa.Column('consignor_ent_sub_region_guid', sa.String(length=36), nullable=True),
    sa.Column('consignee_be_sub_region_guid', sa.String(length=36), nullable=True),
    sa.Column('consignee_ent_sub_region_guid', sa.String(length=36), nullable=True),

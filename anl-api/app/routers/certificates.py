...
class Certificate(BaseModel):
    ...
    # Сертификат/заявка Integer certificate_isrequest_type
    cert_request_type: str = "Certificate request type"
    # Происхождение сертификата Integer certificate_isreqsource_type
    cert_reqsource_type: str = "Certificate reqsource type"
    ...
    # Площадка.Отправитель.Субъект РФ Integer region
    consignor_ent_region: str = "Consignor ent region"
    consignee_be_region: str = "Consignee be region"  # ХС.Получатель.Субъект РФ Integer region
    # Площадка.Получатель.Субъект РФ Integer region
    consignee_ent_region: str = "Consignee ent region"
    ...
    # ХС.Отправитель.Район String(36) SubRegion
    consignor_be_sub_region: str = "Consignor be sub region"
    # ХС.Получатель.Район String(36) SubRegion
    consignee_be_sub_region: str = "Consegnee be sub region"
    # Площадка.Отправитель.Район String(36) SubRegion
    consignor_ent_sub_region: str = "Consegnor ent sub region"
    # Площадка.Получатель.Район String(36) SubRegion
    consignee_ent_sub_region: str = "Consignee ent sub region"
    ...
    # Время в часах с момента оформления до погашения BigNumber
    transit_time_hour: str = "Transit time hour"
...
CERTIFICATES = [Certificate(**{"id": 1}), Certificate(**{"id": 2}), Certificate(**{"id": 3})]
